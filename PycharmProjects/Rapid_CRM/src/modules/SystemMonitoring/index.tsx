      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
        <div className="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100">CPU Usage</h3>
        ...
        <div className="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100">Memory Usage</h3>
              <p className="text-2xl font-semibold text-gray-900 dark:text-gray-100">2.1 GB</p>
            </div>
          </div>
        </div>
