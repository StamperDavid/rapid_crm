    ...
    const companies: Organization[] = [
      {
        ...
        hazmatRequired: 'No',
        phmsaWork: 'No',
        regulatoryDetails: ['Vehicle Safety Standards', 'Driver Qualification Files', 'Hours of Service Compliance'],
      ...
      },
      {
        ...
        numberOfDrivers: 10,
        gvwr: '26,000 lbs',
        vehicleTypes: 'Box Trucks, Vans',
        cargoTypes: 'Package Delivery',
        hazmatRequired: 'No',
        phmsaWork: 'No',
        regulatoryDetails: ['Driver Qualification Files', 'Vehicle Maintenance Records'],
