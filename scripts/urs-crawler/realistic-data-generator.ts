...
export interface RealisticCompanyData {
  // Company Information
...
export class RealisticDataGenerator {
  private companyNumber: number = 0;
  
  /**
   * Generate a complete set of realistic data for one application
   */
  generateCompanyData(): RealisticCompanyData {
    this.companyNumber++;
   ...
   */
  private generateDate(daysFromNow: number): string {
    const date = new Date();
   ...
   */
  getFieldValue(fieldIdentifier: string, data: RealisticCompanyData): string {
    const lower = fieldIdentifier.toLowerCase();
    
    // Company name fields
    if (lower.includes('legal') && lower.includes('name')) return data.legalBusinessName;
    if (lower.includes('dba') || lower.includes('doing business as')) return data.dbaName;
    if (lower.includes('business name') || lower.includes('company name')) return data.legalBusinessName;
    
    // Tax ID / EIN
    if (lower.includes('ein') || lower.includes('tax id') || lower.includes('fein')) return data.einTaxId;
    
    // Mailing Address
    if (lower.includes('mailing') && lower.includes('street')) return data.mailingStreet;
    if (lower.includes('mailing') && lower.includes('address')) return data.mailingStreet;
    if (lower.includes('mailing') && lower.includes('city')) return data.mailingCity;
    if (lower.includes('mailing') && lower.includes('state')) return data.mailingState;
    if (lower.includes('mailing') && lower.includes('zip')) return data.mailingZip;
    
    // Physical Address
    if (lower.includes('physical') && lower.includes('street')) return data.physicalStreet;
    if (lower.includes('physical') && lower.includes('address')) return data.physicalStreet;
    if (lower.includes('physical') && lower.includes('city')) return data.physicalCity;
    if (lower.includes('physical') && lower.includes('state')) return data.physicalState;
    if (lower.includes('physical') && lower.includes('zip')) return data.physicalZip;
    
    // Generic address (could be either)
    if (lower.includes('street') && !lower.includes('mailing') && !lower.includes('physical')) return data.physicalStreet;
    if (lower.includes('address') && !lower.includes('mailing') && !lower.includes('physical')) return data.physicalStreet;
    if (lower.includes('city') && !lower.includes('mailing') && !lower.includes('physical')) return data.physicalCity;
    if (lower.includes('state') && !lower.includes('mailing') && !lower.includes('physical')) return data.physicalState;
    if (lower.includes('zip') && !lower.includes('mailing') && !lower.includes('physical')) return data.physicalZip;
    
    // Contact
    if (lower.includes('phone')) return data.phone;
    if (lower.includes('fax')) return data.fax;
    if (lower.includes('email')) return data.email;
    if (lower.includes('website') || lower.includes('url')) return data.websiteUrl;
    
    // Principal/Owner
    if (lower.includes('first') && lower.includes('name')) return data.principalFirstName;
    if (lower.includes('last') && lower.includes('name')) return data.principalLastName;
    if (lower.includes('title') || lower.includes('position')) return data.principalTitle;
    if (lower.includes('ssn') || lower.includes('social security')) return data.principalSSN;
    if (lower.includes('date of birth') || lower.includes('dob') || lower.includes('birth date')) return data.principalDOB;
    
    // Business Details
    if (lower.includes('year') && (lower.includes('started') || lower.includes('established'))) return data.yearBusinessStarted;
    if (lower.includes('vehicle') && lower.includes('number')) return data.numberOfVehicles;
    if (lower.includes('driver') && lower.includes('number')) return data.numberOfDrivers;
    if (lower.includes('naics')) return data.naicsCode;
    if (lower.includes('revenue') || lower.includes('gross annual')) return data.grossAnnualRevenue;
    
    // Insurance
    if (lower.includes('insurance') && lower.includes('company')) return data.insuranceCompany;
    if (lower.includes('policy') && lower.includes('number')) return data.policyNumber;
    if (lower.includes('effective') && lower.includes('date')) return data.effectiveDate;
    if (lower.includes('expiration') && lower.includes('date')) return data.expirationDate;
    
    // Generic fallbacks
    if (lower.includes('name')) return data.legalBusinessName;
    if (lower.includes('date')) return data.effectiveDate;
    if (lower.includes('number')) return data.policyNumber;
