...
import { PaperAirplaneIcon, MicrophoneIcon, SpeakerWaveIcon } from '@heroicons/react/outline';
...
const SimpleAIChat: React.FC = () => {
        ...
        const speakText = async (text: string) => {
          ...
          try {
            ...
            console.log('🎤 Speaking with voice:', {
              ...
              allVoices: availableVoices.map(v => ({ id: v.id, voiceId: v.voiceId }))
            });
            
            // Validate that we have a valid voice ID
            if (!unrealSpeechVoiceId) {
              console.error('❌ No valid voice ID found for:', selectedVoice);
              setIsSpeaking(false);
              return;
            }
  ...
  const sendMessage = async () => {
    ...
    try {
      // Send message to the working AI endpoint
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">Your intelligent transportation partner</p>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-2">
          ...
          <select
            ...
            className="px-2 py-1 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-white text-xs max-w-32"
          >
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        {messages.length === 0 ? (
          <div className="text-center text-gray-500 dark:text-gray-400 mt-8">
            ...
            <p className="text-lg font-medium">Hello! I'm your Rapid CRM AI assistant.</p>
            <p className="text-sm mt-2">I can help you with transportation compliance, CRM operations, and business intelligence.</p>
        ...
        <div className="flex items-center space-x-3">
          <div className="flex-1">
            <textarea
              ...
              placeholder="Ask me anything about transportation compliance, CRM, or business operations..."
